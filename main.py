...
def worker(id):
    ...
    while i < file_len:
        ...
        filedata = file.read()
        filedata = re.sub(
            "\.|[0-9]{2,4}년|[0-9]{1,2}월|[0-9]{1,2}[월.][^\s]{1,2}[0-9]{1,2}일|[0-9]{4}\-[0-9]{2}-[0-9]{2}|[0-9]{1,2}시|[0-9]{1,2}시 [0-9]{1,2}분|[#][a-zA-Z0-9]{6}|\[youtube\([a-zA-Z0-9]+\)|\[\[http[^]]+|\[\[파일:[^]]+|<[a-zA-Z0-9]+>|<[\-a-zA-Z0-9][a-zA-Z0-9]+>|1[sS][tT]|2[nN][dD]|3[rR][dD]|[4-9][tT][hH]|\{\{\{[+-][0-9]|[0-9.]+%|[0-9.]+[ ~][0-9.]+%",
